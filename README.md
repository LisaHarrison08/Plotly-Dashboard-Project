...
## Completed Dashboard Deployed to Heroku:
### https://plotly-d3-dashboard.herokuapp.com
...
6. Updated the plots each time a new sample was selected.

Designed a dashboard. An example dashboard is shown below:
...
* Updated the chart when a new sample wass selected.
